...
<p class="download">
  <a class="btn btn-dark btn-lg get-started-btn" href="https://github.com/AllyPal/SCCT_Versus_Reloaded/releases/download/v2.1/SCCT.Versus.Reloaded.2.1.zip" role="button">Download</a>
</p>
